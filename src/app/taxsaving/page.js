...
</section>            <section className="about-section" style={{ marginTop: '50px', marginBottom: '50px' }}>
                {/* Container */}
                <div style={{
                    maxWidth: '1200px',
                    margin: '0 auto',
                    ...
                    <h2 style={{
                        ...
                        Taxation Services that Work for You: Maximizing Your Savings, Minimizing Your Stress
                    </h2>
...
<br/>
    ...
    <p style={paraStyle}>
        • <strong>Tax compliance:</strong> This involves ensuring that businesses comply with all relevant tax regulations, including timely filing of tax savings and payment of taxes owed. Our team of tax experts stay up-to-date with the latest tax laws and regulations, ensuring that our clients remain fully compliant.
    </p>
    <p style={paraStyle}>

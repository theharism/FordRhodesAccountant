...
>
  ...
  >
            ...
            <section className="about-section" style={{ marginTop: '50px', marginBottom: '50px' }}>
                ...
                <div style={{
                    ...
                    <h2 style={{
                        ...
                        Count on Us: VAT Returns Services that Help You Achieve Your Financial Goals
                    </h2>
                    ...
                    <p style={{
                        ...
                        Running a business is complex and can drain your time and resources. We aim to take over some of your commitments and give you back more time to devote to the improvement and general day to day running of your business. Our main focus is to ensure that you meet the compliance expectations of HMRC and that you receive the right support and advice to drive your business forward.</p>
    ...
    <p style={paraStyle}>
        From the preparation of your annual accounts to the regular maintenance of your VAT records, we can remove the worry and the effort associated with your basic VAT Returns requirements.
    </p>
...
Strategic Planning, Smart Decisions: VAT Returns Services that Help You Thrive
</h1>
